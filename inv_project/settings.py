...
SECRET_KEY = 'emoo%5!)8pi2h-*)h!4aa5ttclj91rdgilq79m65wulden6$uu'
...
# For admin section of inventory website
# Username - InventoryTbh
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'inv_project/static')
]
